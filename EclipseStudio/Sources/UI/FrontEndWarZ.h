...
public:
	...
	//void initButtons(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount); //frontend
...
private:
	...
	void eventRenameCharacter(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount); //Change name
