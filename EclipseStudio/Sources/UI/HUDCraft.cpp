...
void HUDCraft::FindComp2(int slotid,int itemid)
{
	...
	if (itemid == 101277) // AK-Brazil
	{
		if (slot.Items[i].itemID == 101022) // componente ak-74m
		{
		SendData(slotid,i,itemid,1,1,99999,99999,99999,99999);
		return;
		}
...
void HUDCraft::eventCraftItem(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount)
{
	...
	if (recipesId == 101277) // AK Brazil
	{
		if (slot.Items[i].itemID == 101022) // AK-74M
		{
		FindComp2(i,101277);
		return;
		}
...
void HUDCraft::addRecipes()
{
	...
	{
	Scaleform::GFx::Value var[4];
	var[0].SetUInt(101277);
	var[1].SetString("AK74 Brazil");
	var[2].SetString("Extreme Weapons");
	var[3].SetString("$Data/Weapons/StoreIcons/ASR_AK74_Brazil.dds");
	gfxMovie_.Invoke("_root.api.addRecipe", var, 4);
	}
	...
	// Componentes 1 var1[3]
	// AK-74M
	{
	Scaleform::GFx::Value var1[3];
	var1[0].SetUInt(101022); // AK-74M
	var1[1].SetUInt(301339); // Thread
	var1[2].SetUInt(1);
	...
	{
	Scaleform::GFx::Value var1[3];
	var1[0].SetUInt(101277); // AKBRASIL
	var1[1].SetUInt(101022); // Componente AK-74M
	var1[2].SetUInt(1);
	gfxMovie_.Invoke("_root.api.addRecipeComponent", var1, 3);
	}
	...
	gfxMovie_.Invoke("_root.api.addRecipeComponent", var1, 3);
		...
		// Data para mostrar na lista os itens necessarios para formar o item
		{
