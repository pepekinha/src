...
enum STORE_CATEGORIES
{
	...
	storecat_CraftRe  = 51,		//craft ViruZ
    storecat_CraftCom  = 50,	//craft ViruZ
...
struct wiUserProfile
{
	int		isDevAccount;
	int     isGod;
	int		AccountType; // 0 - legend, 1 - pioneer, 2 - survivor, 3 - guest 4 - Punisher 5 - Premium
